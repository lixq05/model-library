...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/modellibrary?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true";
            String user = "modellibrary";
            String pass = "123456";
